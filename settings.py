...
if socket.gethostname() == 'flakurl.com':
    DEBUG = False
else:
    DEBUG = True
...
ADMINS = (
    ('Viktor Varland', 'viktor@varland.se'),
)
...
DATABASE_NAME = '/home/varl/storage/projects/flakurl/db'             # Or path to database file if using sqlite3.
